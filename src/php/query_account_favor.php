...
//建立SQL語法
$sql = "SELECT  Product.Location, Product.ProductName, Product.ProductSecondType, Product.ProductText, Product.ProductPrice, Favor.FavorID, ProductImg.ProductImgPath1, `Member`.FirstName, `Member`.LastName
from Favor
inner join Product
